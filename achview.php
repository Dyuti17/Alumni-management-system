...
<form id="login" action='achview.php' method='POST'>
<h1>Table 1</h1>
...
<form class="form" action="achievement.php" method="post" enctype="multipart/form-data" autocomplete="off" align="center">
<button type="button" data-toggle="modal" data-target="#achievement" class="btn">Add your achievement</button>
<!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Tell us about your achievements</h4>
      </div>
      <div class="modal-body">
        <form action="achievement.php" id="usrform" align="center" method="post">
        <textarea rows="4" cols="50" name="achievement" required=true ></textarea>
